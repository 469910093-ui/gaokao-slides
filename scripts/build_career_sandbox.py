...
MAJOR_JOBS: dict[str, list[dict[str, str | None]]] = {
    ...
    "护理学": [
        {"title": "临床护士", "slug": None, "ref": "clinic_nurse"},
        {"title": "ICU护士", "slug": None, "ref": "icu_nurse"},
        {"title": "社区护士", "slug": None, "ref": "community_nurse"},
        {"title": "康复护理", "slug": None, "ref": "rehab_nurse"},
        {"title": "老年护理", "slug": None, "ref": "elder_nurse"},
        {"title": "助产士", "slug": None, "ref": "midwife"},
        {"title": "护理管理", "slug": None, "ref": "nurse_mgr"},
        {"title": "健康管理师", "slug": None, "ref": "health_mgr"},
        {"title": "医养结合照护", "slug": None, "ref": "elder_care"},
        {"title": "医院行政支持", "slug": None, "ref": "hospital_admin"},
    ],
    "康复治疗学": [
        {"title": "康复治疗师", "slug": None, "ref": "rehab_therapist"},
        {"title": "物理治疗师", "slug": None, "ref": "physio"},
        {"title": "作业治疗师", "slug": None, "ref": "ot_therapist"},
        {"title": "言语治疗师", "slug": None, "ref": "speech_therapist"},
        {"title": "运动康复教练", "slug": None, "ref": "sports_rehab"},
        {"title": "儿童康复师", "slug": None, "ref": "ped_rehab"},
        {"title": "神经康复师", "slug": None, "ref": "neuro_rehab"},
        {"title": "康复设备工程师", "slug": None, "ref": "rehab_device"},
        {"title": "康复中心管理", "slug": None, "ref": "rehab_mgr"},
        {"title": "社区康复专员", "slug": None, "ref": "community_rehab"},
    ],
    "电子商务": [
        {"title": "电商运营专员", "slug": None, "ref": "ecom_ops"},
        {"title": "直播电商运营", "slug": None, "ref": "live_ecom"},
        {"title": "跨境电商运营", "slug": None, "ref": "cbec"},
        {"title": "店铺运营", "slug": None, "ref": "shop_ops"},
        {"title": "电商数据分析", "slug": None, "ref": "ecom_analyst"},
        {"title": "电商产品经理", "slug": None, "ref": "ecom_pm"},
        {"title": "新媒体电商", "slug": None, "ref": "social_ecom"},
        {"title": "品牌电商运营", "slug": None, "ref": "brand_ecom"},
        {"title": "供应链协调", "slug": None, "ref": "supply_chain"},
        {"title": "客服主管", "slug": None, "ref": "cs_lead"},
    ],
    "土木工程": [
        {"title": "施工员", "slug": None, "ref": "site_eng"},
        {"title": "造价工程师助理", "slug": None, "ref": "cost_estimator"},
        {"title": "监理工程师助理", "slug": None, "ref": "supervision_eng"},
        {"title": "BIM工程师", "slug": None, "ref": "bim_eng"},
        {"title": "结构设计助理", "slug": None, "ref": "struct_assist"},
        {"title": "市政工程技术员", "slug": None, "ref": "municipal_eng"},
        {"title": "工程测量员", "slug": None, "ref": "survey_eng"},
        {"title": "项目资料员", "slug": None, "ref": "project_clerk"},
        {"title": "安全员", "slug": None, "ref": "safety_officer"},
        {"title": "建筑质检员", "slug": None, "ref": "qc_inspector"},
    ],
    "学前教育": [
        {"title": "幼儿园教师", "slug": None, "ref": "preschool_teacher"},
        {"title": "托育教师", "slug": None, "ref": "childcare"},
        {"title": "早教指导师", "slug": None, "ref": "early_edu"},
        {"title": "儿童发展评估", "slug": None, "ref": "child_assess"},
        {"title": "亲子活动策划", "slug": None, "ref": "parent_child"},
        {"title": "幼教机构管理", "slug": None, "ref": "preschool_mgr"},
        {"title": "特殊教育助理", "slug": None, "ref": "special_edu"},
        {"title": "儿童心理辅导", "slug": None, "ref": "child_counsel"},
        {"title": "绘本阅读指导", "slug": None, "ref": "reading_coach"},
        {"title": "社区托育专员", "slug": None, "ref": "community_childcare"},
    ],
    "大数据技术": [
        {"title": "数据分析师", "slug": None, "ref": "data_analyst"},
        {"title": "大数据开发工程师", "slug": None, "ref": "bigdata"},
        {"title": "ETL工程师", "slug": None, "ref": "etl"},
        {"title": "数据仓库工程师", "slug": None, "ref": "dwh"},
        {"title": "BI工程师", "slug": None, "ref": "bi"},
        {"title": "数据运营", "slug": None, "ref": "data_ops"},
        {"title": "数据治理专员", "slug": None, "ref": "data_gov"},
        {"title": "爬虫工程师", "slug": None, "ref": "crawler_eng"},
        {"title": "商业智能分析师", "slug": None, "ref": "bi_analyst"},
        {"title": "数据产品经理", "slug": None, "ref": "data_pm"},
    ],
    "新能源汽车技术": [
        {"title": "新能源汽车维修技师", "slug": None, "ref": "nev_tech"},
        {"title": "三电系统技师", "slug": None, "ref": "nev_power"},
        {"title": "电池检测技师", "slug": None, "ref": "battery_tech"},
        {"title": "充电桩运维", "slug": None, "ref": "ev_charge"},
        {"title": "汽车电子技师", "slug": None, "ref": "auto_elec"},
        {"title": "智能驾驶测试员", "slug": None, "ref": "adas_test"},
        {"title": "整车装配技师", "slug": None, "ref": "assembly_tech"},
        {"title": "售后服务顾问", "slug": None, "ref": "after_sales"},
        {"title": "汽车质检员", "slug": None, "ref": "auto_qc"},
        {"title": "新能源销售技术顾问", "slug": None, "ref": "nev_sales"},
    ],
    "计算机网络技术": [
        {"title": "网络工程师", "slug": None, "ref": "net_admin"},
        {"title": "运维工程师", "slug": None, "ref": "net_ops"},
        {"title": "系统管理员", "slug": None, "ref": "sys_admin"},
        {"title": "网络安全运维", "slug": None, "ref": "secops"},
        {"title": "云计算运维", "slug": None, "ref": "cloud_ops"},
        {"title": "桌面支持工程师", "slug": None, "ref": "desktop_support"},
        {"title": "IDC机房运维", "slug": None, "ref": "idc_ops"},
        {"title": "网络集成工程师", "slug": None, "ref": "net_integrator"},
        {"title": "弱电工程师", "slug": None, "ref": "weak_current"},
        {"title": "IT技术支持", "slug": None, "ref": "it_support"},
    ],
    "机电一体化技术": [
        {"title": "机电设备维修", "slug": None, "ref": "mechatronics_tech"},
        {"title": "PLC编程技术员", "slug": None, "ref": "plc"},
        {"title": "数控技术员", "slug": None, "ref": "cnc_tech"},
        {"title": "设备调试工程师", "slug": None, "ref": "equip_debug"},
        {"title": "工业机器人运维", "slug": None, "ref": "robot_maint"},
        {"title": "自动化产线维护", "slug": None, "ref": "line_maint"},
        {"title": "模具技术员", "slug": None, "ref": "mold_tech"},
        {"title": "质量检测员", "slug": None, "ref": "qc_inspector"},
        {"title": "生产技术员", "slug": None, "ref": "production_tech"},
        {"title": "设备管理专员", "slug": None, "ref": "equip_mgr"},
    ],
    "口腔医学技术": [
        {"title": "口腔技师", "slug": None, "ref": "dental_tech"},
        {"title": "义齿制作技师", "slug": None, "ref": "denture_tech"},
        {"title": "口腔修复技师", "slug": None, "ref": "dental_repair"},
        {"title": "正畸技师助理", "slug": None, "ref": "ortho_assist"},
        {"title": "口腔种植助手", "slug": None, "ref": "implant_assist"},
        {"title": "口腔诊所助理", "slug": None, "ref": "dental_clinic_assist"},
        {"title": "口腔器械销售", "slug": None, "ref": "dental_sales"},
        {"title": "口腔影像技师", "slug": None, "ref": "dental_imaging"},
        {"title": "口腔健康管理", "slug": None, "ref": "oral_health"},
        {"title": "义齿数字化设计", "slug": None, "ref": "cad_dental"},
    ],
    "建筑工程技术": [
        {"title": "施工技术员", "slug": None, "ref": "construction_tech"},
        {"title": "工程测量员", "slug": None, "ref": "survey_eng"},
        {"title": "资料员", "slug": None, "ref": "project_clerk"},
        {"title": "质量员", "slug": None, "ref": "qc_inspector"},
        {"title": "安全员", "slug": None, "ref": "safety_officer"},
        {"title": "材料员", "slug": None, "ref": "material_clerk"},
        {"title": "预算员", "slug": None, "ref": "cost_estimator"},
        {"title": "监理员", "slug": None, "ref": "supervision_eng"},
        {"title": "装配式建筑技术员", "slug": None, "ref": "prefab_tech"},
        {"title": "市政施工员", "slug": None, "ref": "municipal_eng"},
    ],
    "现代物流管理": [
        {"title": "仓储管理", "slug": None, "ref": "warehouse"},
        {"title": "物流协调员", "slug": None, "ref": "logistics_coord"},
        {"title": "供应链专员", "slug": None, "ref": "supply_chain_ops"},
        {"title": "报关报检员", "slug": None, "ref": "customs_broker"},
        {"title": "快递站点管理", "slug": None, "ref": "express_mgr"},
        {"title": "冷链物流专员", "slug": None, "ref": "cold_chain"},
        {"title": "采购专员", "slug": None, "ref": "procurement"},
        {"title": "物流数据分析", "slug": None, "ref": "logistics_analyst"},
        {"title": "国际货运代理", "slug": None, "ref": "freight_forward"},
        {"title": "智慧仓储运维", "slug": None, "ref": "smart_warehouse"},
    ],
    "汉语言文学": [
        {"title": "语文教师", "slug": None, "ref": "chinese_teacher"},
        {"title": "文案策划", "slug": None, "ref": "content"},
        {"title": "编辑", "slug": None, "ref": "journalist"},
        {"title": "新媒体运营", "slug": None, "ref": "new_media"},
        {"title": "行政文秘", "slug": None, "ref": "gov_media"},
        {"title": "公务员笔试辅导", "slug": None, "ref": "civil_servant"},
        {"title": "品牌内容", "slug": None, "ref": "ad_copy"},
        {"title": "出版策划", "slug": None, "ref": "book_design"},
        {"title": "企业文化", "slug": None, "ref": "mkt_comm"},
        {"title": "公关文案", "slug": None, "ref": "pr"},
    ],
    "英语": [
        {"title": "英语教师", "slug": None, "ref": "english_teacher"},
        {"title": "外贸业务员", "slug": None, "ref": "cbec"},
        {"title": "翻译", "slug": None, "ref": "translator"},
        {"title": "外企行政", "slug": None, "ref": "corp_legal"},
        {"title": "跨境客服", "slug": None, "ref": "cs_lead"},
        {"title": "国际会展", "slug": None, "ref": "exhibition"},
        {"title": "英文内容运营", "slug": None, "ref": "content"},
        {"title": "留学顾问", "slug": None, "ref": "consult"},
        {"title": "酒店外宾服务", "slug": None, "ref": "hotel_mgmt"},
        {"title": "商务英语助理", "slug": None, "ref": "ba"},
    ],
    "心理学": [
        {"title": "学校心理老师", "slug": None, "ref": "school_psych"},
        {"title": "人力资源专员", "slug": None, "ref": "hr_generalist"},
        {"title": "用户体验研究", "slug": None, "ref": "ux_research"},
        {"title": "EAP咨询师", "slug": None, "ref": "counselor"},
        {"title": "用户运营", "slug": None, "ref": "user_ops"},
        {"title": "市场调研", "slug": None, "ref": "market_research"},
        {"title": "人才测评", "slug": None, "ref": "talent_assess"},
        {"title": "社区心理服务", "slug": None, "ref": "community_rehab"},
        {"title": "产品经理助理", "slug": None, "ref": "digital_pm"},
        {"title": "培训专员", "slug": None, "ref": "training_spec"},
    ],
}
...
REF: dict[str, dict[str, tuple[int, int]]] = {
    ...
    "clinic_nurse": (6500, 11000),
    "icu_nurse": (7000, 12000),
    "community_nurse": (6000, 10000),
    "rehab_nurse": (6500, 10500),
    "elder_nurse": (6200, 10200),
    "midwife": (6800, 11500),
    "nurse_mgr": (8000, 14000),
    "health_mgr": (7000, 12500),
    "elder_care": (5800, 9800),
    "hospital_admin": (5500, 9500),
    "rehab_therapist": (7000, 12000),
    "physio": (7200, 12500),
    "ot_therapist": (6800, 11500),
    "speech_therapist": (7000, 12000),
    "sports_rehab": (7500, 13000),
    "ped_rehab": (6800, 11500),
    "neuro_rehab": (7500, 12800),
    "rehab_mgr": (8500, 14500),
    "community_rehab": (6500, 11000),
    "site_eng": (6500, 11500),
    "cost_estimator": (7000, 12500),
    "supervision_eng": (6800, 12000),
    "bim_eng": (8000, 14000),
    "struct_assist": (7500, 13000),
    "municipal_eng": (6500, 11500),
    "survey_eng": (6000, 10500),
    "project_clerk": (5500, 9500),
    "safety_officer": (6000, 10500),
    "qc_inspector": (5800, 10000),
    "preschool_teacher": (5000, 8500),
    "childcare": (4500, 7500),
    "early_edu": (5200, 8800),
    "child_assess": (5500, 9200),
    "parent_child": (5000, 8600),
    "preschool_mgr": (6500, 11000),
    "special_edu": (5200, 9000),
    "child_counsel": (5800, 9800),
    "reading_coach": (4800, 8200),
    "community_childcare": (4600, 7800),
    "crawler_eng": (10000, 18000),
    "bi_analyst": (9500, 17000),
    "nev_tech": (6500, 11500),
    "nev_power": (7000, 12500),
    "battery_tech": (6800, 11800),
    "adas_test": (8000, 14000),
    "assembly_tech": (6000, 10500),
    "after_sales": (5500, 9800),
    "auto_qc": (5800, 10200),
    "nev_sales": (6000, 11000),
    "net_admin": (7500, 14000),
    "net_ops": (8000, 14500),
    "sys_admin": (7000, 12500),
    "cloud_ops": (8500, 15000),
    "desktop_support": (6000, 10500),
    "idc_ops": (7500, 13000),
    "net_integrator": (7800, 13500),
    "weak_current": (6500, 11500),
    "it_support": (5800, 10200),
    "mechatronics_tech": (7000, 12500),
    "cnc_tech": (6500, 11500),
    "equip_debug": (7500, 13000),
    "robot_maint": (8000, 14000),
    "line_maint": (7000, 12200),
    "mold_tech": (6800, 11800),
    "production_tech": (6200, 10800),
    "equip_mgr": (7500, 13000),
    "dental_tech": (6000, 10500),
    "denture_tech": (6200, 10800),
    "dental_repair": (6500, 11200),
    "ortho_assist": (6000, 10500),
    "implant_assist": (6500, 11000),
    "dental_clinic_assist": (5500, 9500),
    "dental_sales": (6000, 11500),
    "dental_imaging": (5800, 10000),
    "oral_health": (5500, 9200),
    "cad_dental": (7000, 12500),
    "construction_tech": (6000, 11000),
    "material_clerk": (5200, 9000),
    "prefab_tech": (6500, 11500),
    "logistics_coord": (6500, 11500),
    "supply_chain_ops": (7000, 12500),
    "customs_broker": (6000, 10500),
    "express_mgr": (6200, 10800),
    "cold_chain": (6500, 11200),
    "procurement": (6800, 11800),
    "logistics_analyst": (7500, 13000),
    "freight_forward": (6500, 11500),
    "smart_warehouse": (7000, 12500),
    "chinese_teacher": (6500, 11000),
    "english_teacher": (7000, 12000),
    "translator": (8000, 14500),
    "hotel_mgmt": (6000, 10500),
    "school_psych": (7000, 12500),
    "hr_generalist": (7500, 13500),
    "counselor": (7000, 12000),
    "talent_assess": (8000, 14000),
    "training_spec": (6500, 11500),
}
